...
public class LikeFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (Util.isOnline(getActivity())) {
            new getPost(true, Util.ReadSharePrefrence(current_activity, Constant.SHRED_PR.KEY_USERID)).execute();
        } else {
            Toast.makeText(current_activity, Constant.network_error, Toast.LENGTH_SHORT).show();
        }

        mPullRefreshListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener() {
            @Override
            public void onRefresh() {
                mPullRefreshListView.setLastUpdatedLabel(DateUtils.formatDateTime(current_activity,
                ...
                if (Util.isOnline(getActivity()) == false) {
                    ...
                    new getPost(false, Util.ReadSharePrefrence(current_activity, Constant.SHRED_PR.KEY_USERID)).execute();
                }
            }
        });
    ...
    class getPost extends AsyncTask<Void, String, String> {
        ...
        protected void onPreExecute() {
            ...
            if (flag) {
                if (getActivity() != null) {
                    progressDialog = new ProgressDialog(current_activity, R.style.MyTheme);
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                jData.put("userid", Util.ReadSharePrefrence(current_activity, Constant.SHRED_PR.KEY_USERID));
                jData.put("method", "GetPostLikeByUserid");
        ...
        protected void onPostExecute(String result) {
            ...
            if (getActivity() != null) {
                if (currentpage == 0) {
                    postListAdapter = new PostListAdapter(current_activity, listPost);
